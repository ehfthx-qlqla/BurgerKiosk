...
- Tab키를 눌렀을 때 RadioButton이 포커싱이 되지 않는 오류에서 애를 먹었습니다. 그러나 TabIndex와 TabStop 속성을 이용하여 꼬임을 해결해냈습니다. CheckBox와 RadionButton의 로직이 아예 똑같지만은 않다는 걸 이번 기회에 크게 깨달았습니다.